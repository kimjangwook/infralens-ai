...
urlpatterns = [
    ...
    path("settings/rules/new/", views.rule_create, name="rule_create"),
    path("settings/rules/<uuid:rule_id>/edit/", views.rule_edit, name="rule_edit"),
    ...
    path("api/hooks/stripe/", views.stripe_webhook, name="stripe_webhook"),
